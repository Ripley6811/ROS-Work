...
#kernel_type = 'rbf'  
#kernel_type = 'sigmoid'
clf = svm.SVC(gamma=0.001, C=10, kernel='linear')  # Pretty good result
#clf = svm.SVC(gamma=0.001, C=10, kernel='rbf')  
#clf = svm.SVC(kernel=kernel_type)  # 'linear' or 'rbf'
#clf = svm.SVC(gamma=0.01, C=300, kernel=kernel_type)  # 'linear' or 'rbf'
